            ...
            <div className="container mx-auto px-6 md:px-12">
                <div className="grid lg:grid-cols-12 gap-10 items-center">
                    ...
                    <div className="lg:col-span-8">
                        <h2 className="text-3xl font-[900] text-gray-900 mb-10 tracking-tight">
                            Compare <span className="text-[#E31E24]">Top Business Software</span>
                        </h2>
                            ...
                            {products.map((p, i) => (
                                <div key={i} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:shadow-md transition-shadow">
                                    ...
                                    <div className="mt-auto pt-4 border-t border-gray-50 w-full">
                                        ...
                                        <p className="text-lg font-black text-gray-900 mb-4 tracking-tighter">₹{p.price}</p>
                                        <button className="w-full py-2 bg-red-50 hover:bg-[#E31E24] hover:text-white text-[#E31E24] rounded font-black text-[10px] uppercase tracking-widest transition-all">
                                            Compare Now
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div className="lg:col-span-4 h-full">
                        <div className="bg-white rounded-2xl p-8 flex flex-col justify-center border border-gray-100 shadow-xl relative overflow-hidden h-full">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-red-50/50 rounded-full -mr-16 -mt-16 -z-0"></div>

                            <div className="relative z-10">
                                <h3 className="text-2xl font-[900] text-gray-900 mb-4 leading-tight tracking-tight">Buying for 10+ Employees?</h3>
                                ...
                                <button className="bg-[#003399] text-white py-4 px-8 rounded font-black text-xs uppercase tracking-widest hover:bg-blue-800 transition-all shadow-lg hover:shadow-blue-900/20 w-full md:w-fit active:scale-95">
                                    Request Bulk Quote
                                </button>
                            </div>
                        </div>
